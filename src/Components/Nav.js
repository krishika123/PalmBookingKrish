      ...
      {show ? (
        <div style={styles.PopUp}>
          <div style={styles.PopUpChild}>
            <div>
              <Link to="/profile">
                <img style={styles.AccountImage} src={profileicon}></img>
              </Link>
            </div>
            ...
            <div>
              {auth ? (
                ...
                <button style={styles.Button} type="submit" onClick={login}>
                  {" "}
                  Log In{" "}
                </button>
              )}
            ...
            <div>
              {!auth ? null : (
                <button style={styles.Button} type="submit" onClick={logout}>
                  {" "}
                  Log Out{" "}
                </button>
              )}
